...
<?php foreach ($totals as $total) { ?>
    <div class="simplecheckout-cart-total field-5" id="total_<?php echo $total['code']; ?>">
...
<?php if (isset($modules['coupon'])) { ?>
    <div class="simplecheckout-cart-total field-1">
...
<?php if (isset($modules['reward']) && $points > 0) { ?>
    <div class="simplecheckout-cart-total field-2">
...
<?php } ?>
<?php if (isset($modules['voucher'])&&false) { ?>
    <div class="simplecheckout-cart-total field-3">
...
<?php if (isset($modules['coupon']) || isset($modules['reward']) || isset($modules['voucher'])) { ?>
    <div class="simplecheckout-cart-total simplecheckout-cart-buttons  field-6">
...
<div id="simple_summary" style="display: none;margin-bottom:15px;">
    ...
    <?php foreach ($totals as $total) { ?>
        <div class="simplecheckout-cart-total field-4" id="total_<?php echo $total['code']; ?>">
            <span><b><?php echo $total['title']; ?>:</b></span>
            <span class="simplecheckout-cart-total-value"><nobr><?php echo $total['text']; ?></nobr></span>
        </div>
    <?php } ?>
