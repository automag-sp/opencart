<div class="box">
  <div class="box-heading">Запчасти для ТО</div>
  <div class="box-content filter-content">
    ...
    ?>
    <form action="/index.php?route=saleepc/general/save_model_to" method="POST">
      ...
      <div class="garage">
        <input type="submit" class="button" id="garage_sbm" value="Поиск запчастей" disabled="disabled"/>
      </div>
    </form>
  </div>
</div>