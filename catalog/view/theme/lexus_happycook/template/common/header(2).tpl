				...
				<div class="pull-left">
					<div class="row topbar hidden-sm hidden-xs">
						...
						<ul class="links pull-left">
								...
								<li><a class="shoppingcart" href="<?php echo $shopping_cart; ?>"><span class="fa fa-shopping-cart"></span><span class="text-link hidden-xs hidden-sm"><?php echo $text_shopping_cart; ?></span></a></li>
						</ul>
