...
<?php //require(DIR_TEMPLATE . $this->config->get('config_template') . "/template/common/breadcrumb.tpl"); ?>
    ...
    <style>
        html body#offcanvas-container #_atssh,
        html body#offcanvas-container nav#menu-offcanvas,
        html body#offcanvas-container #page #footer,
        html body#offcanvas-container #page #header {
            dispaly: none;
            height: 1px;
            width: 1px;
            overflow: hidden;
        ...
        html body#offcanvas-container #page #columns #group-content {
            margin: 0;
        }

        html body#offcanvas-container::scrollbar,
        html body#offcanvas-container::-moz-scrollbar,
        html body#offcanvas-container::-ms-scrollbar,
        html body#offcanvas-container::-webkit-scrollbar {
            width: 1px;
        }
