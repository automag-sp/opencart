...
<img src="http://img.autosovet.ru/vag12/AU/<?=substr($saleepc['image']['img'], 6, 3)?>/<?=substr($saleepc['image']['img'], 6, 3).substr($saleepc['image']['img'], 1, 5).substr($saleepc['image']['img'], 0, 1)?>.gif" title="Запчасти" width="380"/>
