...
<?
    ...
    foreach ($saleepc['groups'] as $group){
        echo '<li><a href="/index.php?route=saleepc/hyundai/subgroups&model='.$saleepc['model']['CatFolder'].'&group='.$group['group_id'].$q.'" title="'.$group['group_name'].'">'.$group['group_name'].'</a></li>';    
    }
?>
</ul>
