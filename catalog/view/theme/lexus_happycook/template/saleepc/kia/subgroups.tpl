...
<?
    ...
    foreach ($saleepc['subgroups'] as $subgroup){
        echo '<tr><td>'.$subgroup['fl7'].'</td><td>'.$subgroup['page'].'</td><td><a href="/index.php?route=saleepc/kia/parts&model='.$saleepc['model']['CatFolder'].'&subgroup='.$subgroup['subgroup_id'].$q.'" title="'.$saleepc['model']['CatName'].' '.$subgroup['sgroup_name'].'">'.$subgroup['sgroup_name'].'</a></td><td>';
        /*
