...
<?php
    foreach ($saleepc['vindecodes'] as $vinitm){
        echo '<tr><td valign="top" style="padding: 5px;"><img src="http://img.saleepc.ru/kia/logo/'.$vinitm['model']['CatFolder'].'.jpg" alt="'.$vinitm['model']['CatName'].'" /></td>
        <td valign="top" style="padding: 5px;"><h3>'.$saleepc['vin'].'</h3><a href="/index.php?route=saleepc/kia/groups&model='.$vinitm['model']['CatFolder'].'&vin='.$vinitm['vin'].'&vinid='.$vinitm['id'].'" title="'.$vinitm['model']['CatName'].'">'.$vinitm['model']['CatName'].'</a><br />Date:'.substr($vinitm['dt'], 6, 2).'.'.substr($vinitm['dt'], 4, 2).'.'.substr($vinitm['dt'], 0, 4).'<br /></td><td valign="top"  style="padding: 5px;">';
