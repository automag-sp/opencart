...
class ModelVerticalmenuWidget extends Model {		
	...
	protected function getLayout( $layout ){
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/pavverticalmenu/'.$layout.'.tpl')) {
			$template = $this->config->get('config_template') . '/template/module/pavverticalmenu/'.$layout.'.tpl';
		} else {
			$template = 'default/template/module/pavverticalmenu/'.$layout.'.tpl';
		}
		return $template;
	}
