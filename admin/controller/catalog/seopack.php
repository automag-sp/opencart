...
class ControllerCatalogSeoPack extends Controller{
    ...
    public function index(){
        ...
        if (!$exists) {
            $this->db->query("ALTER TABLE " . DB_PREFIX . "product_description ADD COLUMN `custom_title` varchar(255) NULL DEFAULT '';");
        }
        ...
        if (!$exists) {
            $this->db->query("ALTER TABLE " . DB_PREFIX . "category_description ADD COLUMN `custom_title` varchar(255) NULL DEFAULT '';");
        }
        ...
        if (!$exists) {
            $this->db->query("ALTER TABLE " . DB_PREFIX . "information_description ADD COLUMN `custom_title` varchar(255) NULL DEFAULT '';");
        }
        ...
        if (!$exists) {
            $this->db->query("ALTER TABLE " . DB_PREFIX . "information_description ADD COLUMN `meta_description` varchar(255) NULL DEFAULT '';");
        }
        ...
        if (!$exists) {
            $this->db->query("ALTER TABLE " . DB_PREFIX . "information_description ADD COLUMN `meta_keyword` varchar(255) NULL DEFAULT '';");
        }
    ...
    public function friendlyurls(){
        ...
        $query = $this->db->query("SELECT query FROM " . DB_PREFIX . "url_alias WHERE query = 'common/home'");
        if (!$query->num_rows) {
            $query = "INSERT  INTO " . DB_PREFIX . "url_alias (`query`, `keyword`) VALUES( 'common/home', '')";
            $this->db->query($query);
        }
        $query = $this->db->query("SELECT query FROM " . DB_PREFIX . "url_alias WHERE query = 'account/wishlist'");
        if (!$query->num_rows) {
            $query = "INSERT  INTO " . DB_PREFIX . "url_alias (`query`, `keyword`) VALUES( 'account/wishlist', 'wishlist')";
            $this->db->query($query);
        }
        $query = $this->db->query("SELECT query FROM " . DB_PREFIX . "url_alias WHERE query = 'information/contact'");
        if (!$query->num_rows) {
            $query = "INSERT  INTO " . DB_PREFIX . "url_alias (`query`, `keyword`) VALUES( 'information/contact', 'contact')";
            $this->db->query($query);
        }
        $query = $this->db->query("SELECT query FROM " . DB_PREFIX . "url_alias WHERE query = 'account/account'");
        if (!$query->num_rows) {
            $query = "INSERT  INTO " . DB_PREFIX . "url_alias (`query`, `keyword`) VALUES( 'account/account', 'account')";
            $this->db->query($query);
        }
        $query = $this->db->query("SELECT query FROM " . DB_PREFIX . "url_alias WHERE query = 'checkout/cart'");
        if (!$query->num_rows) {
            $query = "INSERT  INTO " . DB_PREFIX . "url_alias (`query`, `keyword`) VALUES( 'checkout/cart', 'cart')";
            $this->db->query($query);
        }
        $query = $this->db->query("SELECT query FROM " . DB_PREFIX . "url_alias WHERE query = 'checkout/checkout'");
        if (!$query->num_rows) {
            $query = "INSERT  INTO " . DB_PREFIX . "url_alias (`query`, `keyword`) VALUES( 'checkout/checkout', 'checkout')";
            $this->db->query($query);
        }
        $query = $this->db->query("SELECT query FROM " . DB_PREFIX . "url_alias WHERE query = 'information/sitemap'");
        if (!$query->num_rows) {
            $query = "INSERT  INTO " . DB_PREFIX . "url_alias (`query`, `keyword`) VALUES( 'information/sitemap', 'sitemap')";
            $this->db->query($query);
        }
        $query = $this->db->query("SELECT query FROM " . DB_PREFIX . "url_alias WHERE query = 'product/manufacturer'");
        if (!$query->num_rows) {
            $query = "INSERT  INTO " . DB_PREFIX . "url_alias (`query`, `keyword`) VALUES( 'product/manufacturer', 'manufacturer')";
            $this->db->query($query);
        }
        $query = $this->db->query("SELECT query FROM " . DB_PREFIX . "url_alias WHERE query = 'checkout/voucher'");
        if (!$query->num_rows) {
            $query = "INSERT  INTO " . DB_PREFIX . "url_alias (`query`, `keyword`) VALUES( 'checkout/voucher', 'voucher')";
            $this->db->query($query);
        }
        $query = $this->db->query("SELECT query FROM " . DB_PREFIX . "url_alias WHERE query = 'account/voucher'");
        if (!$query->num_rows) {
            $query = "INSERT  INTO " . DB_PREFIX . "url_alias (`query`, `keyword`) VALUES( 'account/voucher', 'gift-voucher')";
            $this->db->query($query);
        }
        $query = $this->db->query("SELECT query FROM " . DB_PREFIX . "url_alias WHERE query = 'affiliate/account'");
        if (!$query->num_rows) {
            $query = "INSERT  INTO " . DB_PREFIX . "url_alias (`query`, `keyword`) VALUES( 'affiliate/account', 'affiliates')";
            $this->db->query($query);
        }
        $query = $this->db->query("SELECT query FROM " . DB_PREFIX . "url_alias WHERE query = 'product/special'");
        if (!$query->num_rows) {
            $query = "INSERT  INTO " . DB_PREFIX . "url_alias (`query`, `keyword`) VALUES( 'product/special', 'special')";
            $this->db->query($query);
        }
        $query = $this->db->query("SELECT query FROM " . DB_PREFIX . "url_alias WHERE query = 'account/login'");
        if (!$query->num_rows) {
            $query = "INSERT  INTO " . DB_PREFIX . "url_alias (`query`, `keyword`) VALUES( 'account/login', 'login')";
            $this->db->query($query);
        }
        $query = $this->db->query("SELECT query FROM " . DB_PREFIX . "url_alias WHERE query = 'account/logout'");
        if (!$query->num_rows) {
            $query = "INSERT  INTO " . DB_PREFIX . "url_alias (`query`, `keyword`) VALUES( 'account/logout', 'logout')";
            $this->db->query($query);
        }
        $query = $this->db->query("SELECT query FROM " . DB_PREFIX . "url_alias WHERE query = 'account/order'");
        if (!$query->num_rows) {
            $query = "INSERT  INTO " . DB_PREFIX . "url_alias (`query`, `keyword`) VALUES( 'account/order', 'order')";
            $this->db->query($query);
        }
        $query = $this->db->query("SELECT query FROM " . DB_PREFIX . "url_alias WHERE query = 'account/newsletter'");
        if (!$query->num_rows) {
            $query = "INSERT  INTO " . DB_PREFIX . "url_alias (`query`, `keyword`) VALUES( 'account/newsletter', 'newsletter')";
            $this->db->query($query);
        }
        $query = $this->db->query("SELECT query FROM " . DB_PREFIX . "url_alias WHERE query = 'account/return/insert'");
        if (!$query->num_rows) {
            $query = "INSERT  INTO " . DB_PREFIX . "url_alias (`query`, `keyword`) VALUES( 'account/return/insert', 'my-returns')";
            $this->db->query($query);
        }
        $query = $this->db->query("SELECT query FROM " . DB_PREFIX . "url_alias WHERE query = 'account/register'");
        if (!$query->num_rows) {
            $query = "INSERT  INTO " . DB_PREFIX . "url_alias (`query`, `keyword`) VALUES( 'account/register', 'register')";
            $this->db->query($query);
        }
        $query = $this->db->query("SELECT query FROM " . DB_PREFIX . "url_alias WHERE query = 'account/forgotten'");
        if (!$query->num_rows) {
            $query = "INSERT  INTO " . DB_PREFIX . "url_alias (`query`, `keyword`) VALUES( 'account/forgotten', 'forgotten')";
            $this->db->query($query);
        }
        $query = $this->db->query("SELECT query FROM " . DB_PREFIX . "url_alias WHERE query = 'account/download'");
        if (!$query->num_rows) {
            $query = "INSERT  INTO " . DB_PREFIX . "url_alias (`query`, `keyword`) VALUES( 'account/download', 'downloads')";
            $this->db->query($query);
        }
        $query = $this->db->query("SELECT query FROM " . DB_PREFIX . "url_alias WHERE query = 'account/return'");
        if (!$query->num_rows) {
            $query = "INSERT  INTO " . DB_PREFIX . "url_alias (`query`, `keyword`) VALUES( 'account/return', 'returns')";
            $this->db->query($query);
        }
        $query = $this->db->query("SELECT query FROM " . DB_PREFIX . "url_alias WHERE query = 'account/transaction'");
        if (!$query->num_rows) {
            $query = "INSERT  INTO " . DB_PREFIX . "url_alias (`query`, `keyword`) VALUES( 'account/transaction', 'transaction')";
            $this->db->query($query);
        }
        $query = $this->db->query("SELECT query FROM " . DB_PREFIX . "url_alias WHERE query = 'affiliate/edit'");
        if (!$query->num_rows) {
            $query = "INSERT  INTO " . DB_PREFIX . "url_alias (`query`, `keyword`) VALUES( 'affiliate/edit', 'edit-affiliate-account')";
            $this->db->query($query);
        }
        $query = $this->db->query("SELECT query FROM " . DB_PREFIX . "url_alias WHERE query = 'affiliate/password'");
        if (!$query->num_rows) {
            $query = "INSERT  INTO " . DB_PREFIX . "url_alias (`query`, `keyword`) VALUES( 'affiliate/password', 'change-affiliate-password')";
            $this->db->query($query);
        }
        $query = $this->db->query("SELECT query FROM " . DB_PREFIX . "url_alias WHERE query = 'affiliate/tracking'");
        if (!$query->num_rows) {
            $query = "INSERT  INTO " . DB_PREFIX . "url_alias (`query`, `keyword`) VALUES( 'affiliate/tracking', 'affiliate-tracking-code')";
            $this->db->query($query);
        }
        $query = $this->db->query("SELECT query FROM " . DB_PREFIX . "url_alias WHERE query = 'affiliate/transaction'");
        if (!$query->num_rows) {
            $query = "INSERT  INTO " . DB_PREFIX . "url_alias (`query`, `keyword`) VALUES( 'affiliate/transaction', 'affiliate-transactions')";
            $this->db->query($query);
        }
        $query = $this->db->query("SELECT query FROM " . DB_PREFIX . "url_alias WHERE query = 'affiliate/logout'");
        if (!$query->num_rows) {
            $query = "INSERT  INTO " . DB_PREFIX . "url_alias (`query`, `keyword`) VALUES( 'affiliate/logout', 'affiliate-logout')";
            $this->db->query($query);
        }
        $query = $this->db->query("SELECT query FROM " . DB_PREFIX . "url_alias WHERE query = 'affiliate/forgotten'");
        if (!$query->num_rows) {
            $query = "INSERT  INTO " . DB_PREFIX . "url_alias (`query`, `keyword`) VALUES( 'affiliate/forgotten', 'affiliate-forgot-password')";
            $this->db->query($query);
        }
        $query = $this->db->query("SELECT query FROM " . DB_PREFIX . "url_alias WHERE query = 'affiliate/register'");
        if (!$query->num_rows) {
            $query = "INSERT  INTO " . DB_PREFIX . "url_alias (`query`, `keyword`) VALUES( 'affiliate/register', 'create-affiliate-account')";
            $this->db->query($query);
        }
        $query = $this->db->query("SELECT query FROM " . DB_PREFIX . "url_alias WHERE query = 'affiliate/login'");
        if (!$query->num_rows) {
            $query = "INSERT  INTO " . DB_PREFIX . "url_alias (`query`, `keyword`) VALUES( 'affiliate/login', 'affiliate-login')";
            $this->db->query($query);
        }
        $query = $this->db->query("SELECT query FROM " . DB_PREFIX . "url_alias WHERE query = 'product/compare'");
        if (!$query->num_rows) {
            $query = "INSERT  INTO " . DB_PREFIX . "url_alias (`query`, `keyword`) VALUES( 'product/compare', 'compare-products')";
            $this->db->query($query);
        }
        $query = $this->db->query("SELECT query FROM " . DB_PREFIX . "url_alias WHERE query = 'product/search'");
        if (!$query->num_rows) {
            $query = "INSERT  INTO " . DB_PREFIX . "url_alias (`query`, `keyword`) VALUES( 'product/search', 'search')";
            $this->db->query($query);
        }
        $query = $this->db->query("SELECT query FROM " . DB_PREFIX . "url_alias WHERE query = 'account/edit'");
        if (!$query->num_rows) {
            $query = "INSERT  INTO " . DB_PREFIX . "url_alias (`query`, `keyword`) VALUES( 'account/edit', 'edit-account')";
            $this->db->query($query);
        }
        $query = $this->db->query("SELECT query FROM " . DB_PREFIX . "url_alias WHERE query = 'account/password'");
        if (!$query->num_rows) {
            $query = "INSERT  INTO " . DB_PREFIX . "url_alias (`query`, `keyword`) VALUES( 'account/password', 'change-password')";
            $this->db->query($query);
        }
        $query = $this->db->query("SELECT query FROM " . DB_PREFIX . "url_alias WHERE query = 'account/address'");
        if (!$query->num_rows) {
            $query = "INSERT  INTO " . DB_PREFIX . "url_alias (`query`, `keyword`) VALUES( 'account/address', 'address-book')";
            $this->db->query($query);
        }
        $query = $this->db->query("SELECT query FROM " . DB_PREFIX . "url_alias WHERE query = 'account/reward'");
        if (!$query->num_rows) {
            $query = "INSERT  INTO " . DB_PREFIX . "url_alias (`query`, `keyword`) VALUES( 'account/reward', 'reward-points')";
            $this->db->query($query);
        }
            ...
            foreach ($query->rows as $manufacturer_row) {
                ...
                if (strlen($manufacturer_row['name']) > 1) {
                    ...
                    if (!$exist_query->num_rows) {
                        ...
                        $exist_keyword = $this->db->query("SELECT query FROM " . DB_PREFIX . "url_alias WHERE " . DB_PREFIX . "url_alias.keyword = '" . $slug . "'");
                        if ($exist_keyword->num_rows) {
                            $slug = $this->generateSlug($manufacturer_row['name']) . '-' . rand();
                        }
