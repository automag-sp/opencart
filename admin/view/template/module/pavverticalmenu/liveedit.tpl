...
<div id="content-s">
	...
	<div class="container">
		...
		<h1 ><?php echo $this->language->get('text_heading_live_edit_verticalmenu') ;?></h1>
 		</div>
		...
		<div id="menu-toolbars">
			...
			<div>
				<div class="pull-right">
					...
					<a id="unset-data-menu" href="#" class="btn btn-danger btn-action"><?php echo $this->language->get('text_reset_verticalmenu');?></a>
...
<script type="text/javascript">
	...
	$("#verticalmenu-content").PavMegamenuEditor( {'action':_action, 'action_menu':_action_menu,'action_widget':_action_widget} );
