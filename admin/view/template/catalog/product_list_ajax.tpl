        ...
        <table class="list">
          ...
          <tbody>
            <tr class="filter">
              ...
              <td><select name="filter_category_id" style="width: 170px;">
                  <option value="*"></option>
		  ...
		  <?php }?>
              ...
              <td align="right"><input type="text" name="filter_quantity" value="<?php echo $filter_quantity; ?>" style="text-align: right; width: 65px;" /></td>
