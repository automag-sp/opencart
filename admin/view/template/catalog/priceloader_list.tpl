        ...
        <table class="list">
          <thead>
            <tr>
              ...
              <td class="left"><?php if ($sort == 'lastupdate') { ?>
                <a href="<?php echo $sort_lastupdate; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_lastupdate; ?></a>
                <?php } else { ?>
                <a href="<?php echo $sort_lastupdate; ?>"><?php echo $column_lastupdate; ?></a>
                <?php } ?></td>
          ...
          <tbody>
            ...
            <tr>
              <td style="text-align: center;"><?php if ($suppler['selected']) { ?>
                <input type="checkbox" name="selected[]" value="<?php echo $suppler['priceloader_id']; ?>" checked="checked" />
                <?php } else { ?>
                <input type="checkbox" name="selected[]" value="<?php echo $suppler['priceloader_id']; ?>" />
                <?php } ?></td>
              <td class="left"><?php echo $suppler['name']; ?></td>
              <td class="left"><?php echo $suppler['lastupdate']; ?></td>
              <td class="right"><?php $c=$suppler['priceloader_id']; if ($c<10) {$c=' 0'.$c;} echo $c; ?></td>
