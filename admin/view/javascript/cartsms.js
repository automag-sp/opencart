...
function smsCounter()
{
    ...
    {
        smsCount = Math.floor($("#smsPreview").val().length / 71 + 1);
    }
    else 
    {
        smsCount = Math.floor($("#smsPreview").val().length / 161 + 1);
    }
...
function countHook(element) {
    ...
    if(unicode) {
        var mnt = [0,1,2,3,4,5];
        var mnl = [0,  1,68,135,202,269,];
        var mnh = [1,68,135,202,269];
        var zaklad;
        var text1;
        var len;
        zaklad = 280;
